                ...
                <div className="h-10 p-3 bg-white shadow-lg rounded-2xl mb-5 h-15">
                    <div className='flex justify-between '>
                        ...
                        <div className='flex gap-2'>
                            <div>
                            <FontAwesomeIcon icon={faTriangleExclamation} className=" text-lg text-gray-500" />
                            </div>
                            <div>
                            <FontAwesomeIcon icon={faLightbulb} className="text-lg text-gray-500 hover:text-gray-500" />
                            
                            </div>
                            <div><svg className="w-6 h-6 text-gray-500 dark:text-[gray]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
